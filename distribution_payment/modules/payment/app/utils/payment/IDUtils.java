...
public class IDUtils {
	...
	public static String buildRefundNo(){
		String str = DateTimeUtils.date2string(new Date(), DateTimeUtils.FORMAT_DATETIME_BACKEND);
     ...
     * @return
     */
    public static String buildOrderNo(String index){
        String orderNo = index;//"YJF_O_";
        orderNo += DateTimeUtils.date2string(new Date(), DateTimeUtils.FORMAT_DATETIME_BACKEND);
        int x=(int)(Math.random()*1000);
        ...
        for(Closeable stream:streams) {
            if(stream != null) {
                try {
                    ...
                    e.printStackTrace();
                    Logger.error("CLUtil closeStream IOException"+e);
                }
            }
        }
    }
    ...
    public static void main(String[] args) {  
        ...
        System.out.println(">>>>>"+buildRefundNo());
    }  
}
