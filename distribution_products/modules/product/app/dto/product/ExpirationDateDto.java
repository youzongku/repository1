...
public class ExpirationDateDto {
	...
	public ExpirationDateDto(String sku, Integer warehouseId,
			String expirationDate, Integer subStock) {
		super();
		this.sku = sku;
	...
	public String toString() {
		return "ExpirationDto [sku=" + sku + ", warehouseId=" + warehouseId
				+ ", subStock=" + subStock + ", expirationDate="
				+ expirationDate + "]";
	}
