...
import util.timer.PriceFormatUtil;
...
public class PurchaseOrder implements java.io.Serializable {
	...
	private Boolean isPro = Boolean.FALSE;// 是否存在活动

	private Boolean isChoose = Boolean.FALSE;// 是否已选优惠

	private String inputUser;// 录入人

	private Double offlineMoney;// 现金交易支付金额
	@Deprecated
	private boolean hasAssociatedOrders; // 是否有关联订单--弃用
	...
	public double calculatePurchaseFinalAmount() {
		...
		double doubleValue = finalAmount.setScale(2, BigDecimal.ROUND_HALF_UP)
				.doubleValue();
		if (doubleValue < 0) {
			return 0.00;
		}
	...
	public String toString() {
		return "PurchaseOrder [id=" + id + ", email=" + email
				...
				+ ", payerIp=" + payerIp + ", payDate=" + payDate
				+ ", payHost=" + payHost + ", remarks=" + remarks
				+ ", purchaseTotalAmount=" + purchaseTotalAmount
				+ ", validablePayDate=" + validablePayDate + ", purchaseDate="
				+ purchaseDate + ", payerIdcard=" + payerIdcard
				+ ", payerName=" + payerName + ", purchaseType=" + purchaseType
				+ ", sid=" + sid + ", purchaseDiscountAmount="
				...
				+ ", isPro=" + isPro + ", isChoose=" + isChoose
				+ ", inputUser=" + inputUser + ", offlineMoney=" + offlineMoney
				...
				+ ", reducePrice=" + reducePrice + ", tAWPrice=" + tAWPrice
				+ ", oaAuditNo=" + oaAuditNo + ", busenessRemarks="
				+ busenessRemarks + "]";
	}
