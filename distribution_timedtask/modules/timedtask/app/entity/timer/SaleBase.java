...
public class SaleBase {
	...
	private Double orderTotalAmount;//发货单总金额

	private Double orderActualAmount;//发货单实际金额
	...
	public String getOrderingDateStr() {
		return orderingDateStr;
	}

	public void setOrderingDateStr(String orderingDateStr) {
		this.orderingDateStr = orderingDateStr;
	}
	...
	public String toString() {
		return "SaleBase [id=" + id + ", platformOrderNo=" + platformOrderNo + ", platformType=" + platformType
				...
				+ orderTotalAmount + ", orderActualAmount=" + orderActualAmount + ", orderPostage=" + orderPostage
				+ ", orderingDate=" + orderingDate + ", orderingDateStr=" + orderingDateStr + ", remark=" + remark
				+ ", salesOrderId=" + salesOrderId + ", shopId=" + shopId + ", addrId=" + addrId + ", address="
				...
				+ ", bbcPostage=" + bbcPostage + ", logisticsMode=" + logisticsMode + ", couponsCode=" + couponsCode
				+ ", couponsAmount=" + couponsAmount + ", createUser=" + createUser + ", isBack=" + isBack + "]";
	}
