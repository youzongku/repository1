...
public class SalesToB2cIterm {
    ...
    private String printTemplate;//电子面单 Html内容

    private String logisticCode;//快递鸟 -快递单号
    
    private String combineOrderNo;//合并发货单
    
    private Integer combineOrderCount;//合并发货单数量
