...
public class KdtApiClient {
	...
	public HttpResponse get(String method, Map<String,String> parames) throws Exception{
	...
	public HttpResponse post(String method, Map<String, String> parames, List<String> filePaths, String fileKey) throws Exception{
    	String url = apiEntry + getParamStr(method, parames);
    ...
    public String getParamStr(String method, Map<String, String> parames){
        String str = "";
        try {
    ...
    private HashMap<String, String> buildCompleteParams(String method, Map<String, String> parames) throws Exception{
