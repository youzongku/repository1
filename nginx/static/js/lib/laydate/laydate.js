...
!function (a) {
    var b = {
        ...
        isv: !1
    }, c = {}, d = document, e = "createElement", f = "getElementById", g = "getElementsByTagName", h = ["laydate_box", "laydate_void", "laydate_click", "LayDateSkin", "../js/laydate/skins/", "/laydate.css"];
    a.laydate = function (b) {
        ...
        var f = d[e]("link");
        f.type = "text/css", f.rel = "stylesheet", f.href = c.getPath + a + h[5], b && (f.id = b), f = null
    }, c.trim = function (a) {
