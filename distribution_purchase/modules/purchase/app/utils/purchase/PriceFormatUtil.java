...
public class PriceFormatUtil {
	...
	public static BigDecimal setScale2(BigDecimal bigDecimal){
		...
		return new BigDecimal(toFix2(bigDecimal));
	}
     ...
     * @return
     */
    private static DecimalFormat toFour = new DecimalFormat("###0.0000");
    public static Double toFix4(Double val) {
    	if(val != null){
	        return Double.parseDouble(toFour.format(val));
    	}
    	return 0.00;
    }
}
