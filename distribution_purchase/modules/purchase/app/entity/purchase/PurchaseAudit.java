...
public class PurchaseAudit implements Serializable {
    ...
    private String recipientName;//收款账户名
	...
	public String toString() {
		return "PurchaseAudit [id=" + id + ", transferCard=" + transferCard + ", status=" + status + ", statusName="
				+ statusName + ", purchaseNo=" + purchaseNo + ", transferNumber=" + transferNumber + ", transferAmount="
				+ transferAmount + ", transferTime=" + transferTime + ", screenshotUrl=" + screenshotUrl
				+ ", auditReasons=" + auditReasons + ", auditRemark=" + auditRemark + ", applyRemark=" + applyRemark
				+ ", transferName=" + transferName + ", email=" + email + ", recipientCardId=" + recipientCardId
				+ ", createDate=" + createDate + ", updateDate=" + updateDate + ", transferType=" + transferType
				+ ", createUser=" + createUser + ", orderAmount=" + orderAmount + ", recipientAccount="
				+ recipientAccount + ", orderDate=" + orderDate + ", receivedAmount=" + receivedAmount
				+ ", receivedTime=" + receivedTime + ", customerService=" + customerService + ", recipientName="
				+ recipientName + "]";
	}
