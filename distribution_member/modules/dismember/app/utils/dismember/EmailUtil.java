...
public class EmailUtil {
	public static boolean send(String title, String content, EmailAccount account, String toEmail) {
		if (account == null || toEmail == null || title == null || title.equals("") || content == null
				|| content.equals("")) {
			Logger.info("参数缺失，account：" + account + ",toemail:" + toEmail + ",title:" + title + ",content:" + content);
			return false;
		}
