...
public class AccountPeriodMaster implements Serializable{
    ...
    /**
     * 周期类型：0（天）、1（自然月）、2（固定月结）
     */
    private Integer periodType;

    /**
     * 周期长度，与周期类型（periodType）配合使用
     */
	...
	public String toString() {
		return "AccountPeriodMaster [id=" + id + ", account=" + account + ", totalLimit=" + totalLimit
				+ ", dutyOfficer=" + dutyOfficer + ", oaAuditCode=" + oaAuditCode + ", contractNo=" + contractNo
				+ ", periodType=" + periodType + ", periodLength=" + periodLength + ", rechargeTotal=" + rechargeTotal
				+ ", rechargeLeft=" + rechargeLeft + ", createUser=" + createUser + ", createDate=" + createDate
				+ ", updateDate=" + updateDate + ", nickName=" + nickName + ", disModeDesc=" + disModeDesc
				+ ", disMode=" + disMode + ", usedLimit=" + usedLimit + ", effectCount=" + effectCount + "]";
	}
